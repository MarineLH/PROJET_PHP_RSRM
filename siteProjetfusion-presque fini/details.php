            ...
            <div class="wrapper">
                ...
                else if(isset($_GET['idAnn']))
                {
                    ...
                    while($row= mysqli_fetch_assoc($Result))
                    {
                        ...
                        print('<p><a class="repondre" href="contact.php?idOrg='.$row['org_id'].'">Répondre à l\'annonce</a>');
                        print('</fieldset>');
                    }
                }
                else // GET idInt
                {
                    ...
                    print('<p><a class="repondre" href="contact.php?idInt='.$rowI['int_id'].'">Contacter</a>');
                    print('</fieldset>');
                }
                ?>
            </div>
