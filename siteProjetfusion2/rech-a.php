                        ...
                        if(isset($_POST['recherche'])){  
                            ...
                            foreach ($_POST['chckDom'] as $index=>$value)
                            {
                               ...
                               WHERE rec_active = 1 AND dom_id = ".$value);
                                ...
                                {
                                    print('<tr>');
                                    print('<td>'.$row['dom_libelle'].'</td><td>'.$row['org_nom'].'</td><td>' .$row['org_ville'].'</td><td>'.$row['org_codepostal'].'</td><td>'.$row['rec_titre'].'</td><td>'.$row['rec_datelimiteintervention'].'</td><td>'.$row['rec_description'].'</td><td class="repondre"><a href="contact.php?annID='.$row['rec_id'].'">Répondre</a></td></tr>');
                                }
                            }
                            print('</table></form>');
                        }
