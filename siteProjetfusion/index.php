        ...
        <div class="contenu">
            ...
            <div class="wrapper">
                ...
                <form method="post" action="<?php $_PHP_SELF ?>">
				    <fieldset><legend>Connexion : entre votre email</legend>
                    <p><label for="email">Email : </label><input type="text" name="email" tabindex="1" required autocomplete="off"/></p>
                    <p><input value="Se connecter" class="button" name="bt_conn" type="submit"/></p>
                    </fieldset>
                </form>
                <?php
                }
