        ...
        <div class="contenu">
            ...
            <div class="wrapper">
                <?php 
                    ...
                    {
                        ?>
                        <h2 class="titrePage">Rechercher une annonce :</h2>             
                        ...
                        print("</tr></table>");
                        print('<input type="submit" class ="rechercher"name="recherche" value="Rechercher"/></fieldset></div></form>');
                        mysqli_free_result($result);
                    }
                    else
                    {
                        if(empty($_POST['chckDom']))
                        {
                            print('<script>alert("Il faut cocher au moins une compétence pour effectuer la recherche.");</script>');
                            unset($_POST);
                            print('<meta http-equiv="refresh" content="0;url=rech-a.php" />');
                        }
                        else{
