...
CREATE TABLE `estcompetent` (
  ...
  `comp_idintervant` int(11) NOT NULL,
  PRIMARY KEY (`comp_iddomaine`,`comp_idniveau`,`comp_idintervant`),
  KEY `fk_compniveau` (`comp_idniveau`),
  KEY `fk_compintervant` (`comp_idintervant`),
  CONSTRAINT `fk_compdomaine` FOREIGN KEY (`comp_iddomaine`) REFERENCES `domaine` (`dom_id`),
  CONSTRAINT `fk_compintervant` FOREIGN KEY (`comp_idintervant`) REFERENCES `intervenant` (`int_id`),
...
CREATE TABLE `organisme` (
  ...
  `org_villle` varchar(100) NOT NULL,
...
INSERT INTO `organisme` VALUES (1,'Le poulet blanc','poueltblanc@gmail.com','0628543247','33000','bordeaux',1),(2,'La plume du voyageur','plumeduvoyageur@gmail.com','0628543248','75000','paris',1),(3,'Le dortoir d\'Ulis','dortoirdulis@gmail.com','0628543249','13000','marseille',1);
...
-- Dump completed on 2015-12-16 11:23:53
